                ...
                <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2">
                        <input
                          ...
                          className="w-12 h-12 sm:w-10 sm:h-10 rounded-xl border border-border/20 cursor-pointer bg-transparent"
                        />
                        <input
                          type="text"
                          value={tempPrimary}
                          onChange={(e) => setTempPrimary(e.target.value)}
                          className="flex-1 glass-input border rounded-xl px-3 py-2.5 text-sm sm:text-xs text-foreground font-mono"
                          maxLength={7}
                        />
                      </div>
                    </div>
                  ...
                  <div className="rounded-2xl p-4 border border-border/20" style={{ backgroundColor: tempBg }}>
                    ...
                    <div className="flex gap-2">
                      ...
                      <div className="h-8 w-16 rounded-xl flex items-center justify-center text-[10px] font-bold text-white" style={{ backgroundColor: tempPrimary }}>
                        Botão
                      </div>
                  ...
                  <div className="flex gap-2 pt-1">
                    <button
                      ...
                      className="flex-1 py-3 rounded-2xl text-sm sm:text-xs font-medium text-muted-foreground/60 bg-muted/20 hover:bg-muted/30 transition-all active:scale-[0.98]"
                    >
                      Voltar
                    </button>
                    <button
                      onClick={handleApplyCustom}
                      className="flex-1 py-3 rounded-2xl text-sm sm:text-xs font-bold text-primary-foreground bg-primary hover:bg-primary/90 transition-all flex items-center justify-center gap-1.5 active:scale-[0.98]"
                    >
                      <Pipette size={14} />
                      Aplicar
                    </button>
